...
def getNumberOfVictoryCards(numPlayers):
    if numPlayers > 2:
        return 12
    else:
        return 8
...
def getNumberOfCurses(numPlayers):
...
def getSupplyOrder():
    so = {  0: ['Curse', 'Copper'], 2: ['Estate', 'Cellar', 'Chapel', 'Moat'],
...
def getSupplyFromBox(box, numPlayers, nV, nC):
